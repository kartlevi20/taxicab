...
if ( !function_exists('lte_get_fa5_icons') ) {

	function lte_get_fa5_icons() {
		...
		$fontawesome_icons = array(
			...
			'Religion' => array(
				...
				array( 'fas fa-haykal' => 'Haykal (bahai,bahГЎ\'Г­,star)' ),
		...
		$icons = array();
		foreach ( $fontawesome_icons as $icons_class => $ico ) {

			foreach ( $ico as $iclass => $item ) {
	...
	function limme_fw_add_more_packs( $default_packs ) {

		$file = limme_get_fontello_css();
		$fontello = limme_get_fontello_path();
		$packs = array();

		if ( !empty($file) ) {

			$packs['limme_theme_icons'] = array(

				'name' => 'limme_theme_icons',
				'title' => 'Limme Theme Icons',
				'css_class_prefix' => 'icon',

				'css_file' => $file,
				'css_file_uri' => $fontello['css']['url'],

				'admin_wp_enqueue_handle' => 'limme-fontello',
				'frontend_wp_enqueue_handle' => 'limme-fontello',
		...
		$packs['limme_fa5_icons'] = array(
				
			'name' => 'limme_fa5_icons',
			'title' => 'Font Awesome 5 Free',

			'admin_wp_enqueue_handle' => 'limme-fontawesome-5',
			'frontend_wp_enqueue_handle' => 'limme-fontawesome-5',

			'require_css_file' => false,
			'icons' => false,

			'apply_root_class' => false,
			'load_icons_callback' => 'lte_get_fa5_icons'
		);		

		return $packs;
	}

	add_filter( 'fw:option_type:icon-v2:packs', 'limme_fw_add_more_packs' );			

	function limme_fw_custom_packs($current_packs) {

	    return array('limme_fa5_icons', 'limme_theme_icons');
	}

	add_filter('fw:option_type:icon-v2:filter_packs', 'limme_fw_custom_packs');	
}
