...
*/ 
$labels = array(
	'name'               => esc_html__( 'Product Sliders', 'lte-ext' ),
	'singular_name'      => esc_html__( 'Product Slider', 'lte-ext' ),
	'menu_name'          => esc_html__( 'Product Sliders', 'lte-ext' ),
	'name_admin_bar'     => esc_html__( 'Product Sliders', 'lte-ext' ),
...
register_post_type( 'sliders-full', $args );	
...
register_taxonomy( 'sliders-full-category', array( 'sliders-full' ), $args );
