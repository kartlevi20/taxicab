...
$labels = array(
	'name'               => esc_html__( 'Testimonials', 'lte-ext' ),
	'singular_name'      => esc_html__( 'Testimonial', 'lte-ext' ),
	'menu_name'          => esc_html__( 'Testimonials', 'lte-ext' ),
	'name_admin_bar'     => esc_html__( 'Testimonial', 'lte-ext' ),
	'add_new'            => esc_html__( 'Add New', 'lte-ext' ),
	'add_new_item'       => esc_html__( 'Add New Testimonial', 'lte-ext' ),
	'new_item'           => esc_html__( 'New Testimonial', 'lte-ext' ),
	'edit_item'          => esc_html__( 'Edit Testimonial', 'lte-ext' ),
	'view_item'          => esc_html__( 'View Testimonial', 'lte-ext' ),
	'all_items'          => esc_html__( 'All Testimonials', 'lte-ext' ),
	'search_items'       => esc_html__( 'Search Testimonials', 'lte-ext' ),
	'parent_item_colon'  => esc_html__( 'Parent Testimonials:', 'lte-ext' ),
