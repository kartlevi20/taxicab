...
class lte_Widget_Navmenu extends WP_Widget {
    ...
    function __construct() {
        ...
        $this->prefix = "navmenu";
        $widget_ops = array( 'description' => esc_html__( 'Displays two-column navmenu', 'lte-ext' ) );
        parent::__construct( false, esc_html__( 'LTE Navmenu', 'lte-ext' ), $widget_ops );
    ...
    function print_widget_javascript() {
        ...
        wp_add_inline_script( 'jquery-core', '
            jQuery(function($) {
                ...
                function lteNavmenuWidgetsReinit(selector) {                  
                    ...
                    $("#" + selector).on("remove", function(){ // ReInit options on html replace (on widget Save)
                        ...
                        timeoutId = setTimeout(function(){ // wait a few milliseconds for html replace to finish
                            ...
                            lteNavmenuWidgetsReinit(selector);
                        }, 100);
                    });           
                }

                $("#widgets-right .fw-theme-admin-widget-wrap").each(function(i, el) { 
                    lteNavmenuWidgetsReinit($(this).attr("id"));
                });
            });
        ' );
    }
