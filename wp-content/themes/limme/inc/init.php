...
class Limme_Theme_Includes {
	...
	public static function init() {
		...
		add_action( 'init', array( __CLASS__, 'limme_action_init' ) );
		...
		if ( !is_admin() ) {
			...
			add_action('wp_enqueue_scripts', array( __CLASS__, 'limme_action_enqueue_scripts' ), 20 );
		}
	}

	public static function limme_action_enqueue_scripts() {
		
		self::include_child_first( '/static.php' );
	}

	public static function limme_action_init() {
