 ...
 */ 
if ( ! function_exists( 'limme_paging_nav' ) ) {

	function limme_paging_nav( $wp_query = null ) {
		...
		<nav class="navigation paging-navigation">
			<h3 class="screen-reader-text"><?php echo esc_html__( 'Posts navigation', 'limme' ); ?></h3>
 ...
 */
if ( ! function_exists( 'limme_post_nav' ) ) {

	function limme_post_nav() {
		...
		<nav class="navigation post-navigation clearfix" role="navigation">
			<h3 class="screen-reader-text"><?php echo esc_html__( 'Post navigation', 'limme' ); ?></h3>
 ...
 */
function limme_categorized_blog() {

	if ( false === ( $all_the_cats = get_transient( 'limme_category_count' ) ) ) {
		...
		set_transient( 'limme_category_count', $all_the_cats );
	}
